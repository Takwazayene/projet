    ...
    <div class="single-product-area">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
				  <form  method="POST" >
                                <input type="text" placeholder="id Commande" name="choix" />
									  <input type="submit" name="rechercher" value="rechercher"> 
                               </form>
							   <?php
							    if (isset($_POST["rechercher"]) && isset($_POST["choix"]) ){
						
							   $listeCommandes=$commande1C->rechercher($_POST["choix"]);
								}
							   ?>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="product-subtotal">date</th>
											 <th class="product-subtotal">livraison</th>
											<th class="product-name">quantite</th>
                                            <th class="product-price">total</th>
                                            <th class="product-quantity">etat</th>
                                            <th class="product-subtotal">supprimer</th>
											<th class="product-subtotal">modifier</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr class="cart_item">
