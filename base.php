                ...
                <div class="user-menu">
                    <ul>
						...
						if ( Config::getUserSession() == null ) {
							echo '<li><a href="' . curPageURL() . '/views/login/signup.php"><i class="fa fa-user"></i> SignUp</a></li>';
							echo '<li><a href="' . curPageURL() . '/views/login/login.php"><i class="fa fa-user"></i> Login</a></li>';
						} else {
							echo '<li><a href="' . curPageURL() . '/views/login/profile"><i class="fa fa-user"></i> My Account</a></li>';
							echo '<li><a href="' . curPageURL() . '/views/login/logout.php"><i class="fa fa-user"></i> logout</a></li>';
                            echo '<li><a href="' . curPageURL() . '/views/paniers/afficherPanier.php"><i class="fa fa-user"></i> Cart</a></li>';
						}
						?>
                    </ul>
                </div>
        ...
        <div class="row">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="service.html">Services Rappides</a></li>
